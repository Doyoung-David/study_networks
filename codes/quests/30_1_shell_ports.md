...
---
```bash
Var_port=$(ss -tulnp | grep "$1\|$2\|$3\|$4\|$5" | cut -d" " -f23 | cut -d":" -f2)
if [ "$1" == ("grep $1 $Var_port") ]; then
        echo "Port $1 is working."
else
        echo "Port $1 is not working."
fi
if [ "$2" == ("grep $2 $Var_port") ]; then
        echo "Port $2 is working."
else
        echo "Port $2 is not working."
fi
if [ "$3" == ("grep $3 $Var_port") ]; then
        echo "Port $3 is working."
else
        echo "Port $3 is not working."
fi
if [ "$4" == ("grep $4 $Var_port") ]; then
        echo "Port $4 is working."
else
        echo "Port $4 is not working."
fi
if [ "$5" == ("grep $5 $Var_port") ]; then
        echo "Port $5 is working."
else
        echo "Port $5 is not working."
fi
```
...
```bash
if [(lsof -i) == "$1"]; then
        port=$(cut -d" " -f2 | tail -1)
        kill -9 port    
        echo "$port has been eliminated."
else    
        echo "No such port."
